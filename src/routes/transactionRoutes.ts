...
import { createTransactionByUserId, getAllTransactionByUserId, getTransactionById, importTransactionByUserId, uploadTransactionSlipById } from "../controllers/transactionController";
...
const transactionRoues = async(fastify:FastifyInstance) =>{
    ...
    fastify.post("/transactions/import-excel", importTransactionByUserId);
}
